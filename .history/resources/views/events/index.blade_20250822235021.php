...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="p-6">
                ...
                <div class="mb-4">
                    <div class="text-center mb-4">
                        <div class="text-2xl font-bold text-amber-600 attendee-count" data-event="haldi">{{ $haldiCount }}</div>
                        <div class="text-sm text-gray-500">People Attending</div>
                    </div>
                    <div class="space-y-3">
                        <a href="{{ route('event.show', 'haldi') }}" 
                           class="block w-full px-4 py-3 bg-amber-600 text-white text-center rounded-lg hover:bg-amber-700 transition-colors font-semibold">
                            🌺 View Details
                        </a>
    ...
    <div class="text-center">
        <div class="bg-white/90 rounded-xl p-8 inline-block border border-gray-200/50">
            <h3 class="text-2xl font-bold text-gold-shining mb-4">Why Join Us?</h3>
            <div class="grid md:grid-cols-3 gap-6 text-center">
                <div>
                    <div class="text-3xl mb-2">🎭</div>
                    <h4 class="font-semibold text-gold">Cultural Experience</h4>
                    <p class="text-sm text-gray-600">Immerse in authentic traditions</p>
                </div>
                <div>
                    <div class="text-3xl mb-2">🍛</div>
                    <h4 class="font-semibold text-gold">Delicious Food</h4>
                    <p class="text-sm text-gray-600">Traditional cuisine & treats</p>
                </div>
                <div>
                    <div class="text-3xl mb-2">👨‍👩‍👧‍👦</div>
                    <h4 class="font-semibold text-gold">Family Fun</h4>
