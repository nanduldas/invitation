...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    @if($event === 'haldi')
        ...
        <div class="bg-white/95 rounded-xl shadow-xl overflow-hidden">
            <div class="gradient-haldi h-64 flex items-center justify-center">
                <div class="text-center text-white">
                    <div class="text-8xl mb-4">🌺</div>
                    <h1 class="text-4xl md:text-5xl font-bold">Haldi Ceremony</h1>
                    <p class="text-xl mt-2">A Sacred & Joyful Celebration</p>
                </div>
            </div>
            ...
            <div class="p-8">
                <div class="grid md:grid-cols-2 gap-8 mb-8">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800 mb-4">About the Ceremony</h2>
                        ...
                        <h3 class="text-lg font-semibold text-gray-800 mb-2">What to Expect:</h3>
                    ...
                    <div>
                        ...
                        <div class="bg-yellow-50 rounded-lg p-6 space-y-4">
                            ...
                            <div class="flex items-center">
                                <span class="text-2xl mr-3">📍</span>
                                <div>
                                    <div class="font-semibold text-gray-800">Venue</div>
                            ...
                            <div class="flex items-center">
                                <span class="text-2xl mr-3">👗</span>
                                <div>
                                    <div class="font-semibold text-gray-800">Dress Code</div>
                        ...
                        <div class="mt-6 text-center">
                            <div class="bg-yellow-100 rounded-lg p-4 mb-4">
                                <div class="text-3xl font-bold text-yellow-700 attendee-count" data-event="haldi">{{ $attendeesCount }}</div>
                                <div class="text-yellow-600">People Attending</div>
                            </div>
                            <button onclick="openModal('haldi')" 
                                    class="w-full px-6 py-3 bg-pink-600 text-white rounded-lg hover:bg-pink-700 transition-colors text-lg font-semibold">
                ...
                <div class="bg-gradient-to-r from-yellow-100 to-pink-100 rounded-lg p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-3">Traditional Significance</h3>
    ...
    @else
        <!-- Onam Event Details -->
        <div class="bg-white/95 rounded-xl shadow-xl overflow-hidden">
            <div class="gradient-onam h-64 flex items-center justify-center">
                <div class="text-center text-white">
                    <div class="text-8xl mb-4">🌾</div>
                    <h1 class="text-4xl md:text-5xl font-bold">Onam Festival</h1>
                    <p class="text-xl mt-2">The Harvest Festival of Kerala</p>
                </div>
            </div>
            ...
            <div class="p-8">
                <div class="grid md:grid-cols-2 gap-8 mb-8">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800 mb-4">About Onam</h2>
                        <p class="text-gray-600 mb-4">
                        ...
                        <h3 class="text-lg font-semibold text-gray-800 mb-2">Festival Highlights:</h3>
                        <ul class="text-gray-600 space-y-1">
                    ...
                    <div>
                        ...
                        <div class="bg-blue-50 rounded-lg p-6 space-y-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="font-semibold text-gray-800">Special</div>
                        ...
                        <div class="mt-6 text-center">
                            <div class="bg-blue-100 rounded-lg p-4 mb-4">
                                <div class="text-3xl font-bold text-blue-700 attendee-count" data-event="onam">{{ $attendeesCount }}</div>
                                <div class="text-blue-600">People Attending</div>
                            </div>
                            <button onclick="openModal('onam')" 
                                    class="w-full px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-lg font-semibold">
                ...
                <div class="bg-gradient-to-r from-blue-100 to-green-100 rounded-lg p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-3">The Legend of King Mahabali</h3>
                    <p class="text-gray-700">
