                    ...
                    <div>
                        ...
                        <div class="mt-6 text-center">
                            <div class="bg-amber-100 rounded-lg p-4 mb-4">
                                <div class="text-3xl font-bold text-amber-700 attendee-count" data-event="haldi">{{ $attendeesCount }}</div>
                                <div class="text-amber-600">People Attending</div>
                            </div>
                            <button onclick="openModal('haldi')" 
                                    class="w-full px-6 py-3 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors text-lg font-semibold">
